...
file_path = r'C:\Users\Harry Murphy\OneDrive\Desktop\Low_Spec_Adjusted.csv'
...
smoothed_dayrate_extended = processed_data['Min Lead Dayrate'].rolling(window=6, center=True).mean().fillna(method='ffill').fillna(method='bfill')
